...
- Admin dashboard tại `/admin/` để tạo tài khoản admin, cấu hình Chatwoot/OA, thêm inbox, quản lý proxy, quét QR, xem/export log và ẩn cảnh báo đã xử lý.
...
Kiểm tra local gần nhất trên code hiện tại: 71 test file pass, 7 test file skip có chủ ý; 440 test
